...
public class TravelEndpointTokenTest {
    @Autowired
    ...
    public void configProtectedHeaders() {
        String str = "{\"usernameOrEmail\":\"eamoraes\",\"password\":\"123456\"}";
        HttpHeaders headers = restTemplate.postForEntity("/api/auth/signin", str, String.class).getHeaders();
    ...
    @Before
    public void setup() {
        Travel travel = new Travel("Paris", "www.google.com/img.jpg", null);
        BDDMockito.when(travelRepository.findById(1L).get()).thenReturn(travel);
    }


    @Test
    public void listStudentsWhenTokenIsIncorrectShouldReturnStatusCode403() {
        ResponseEntity<String> response = restTemplate.exchange("/api/travels/",GET,wrongHeader, String.class);
...
/*
    ...
    public void getStudentsByIdWhenTokenIsIncorrectShouldReturnStatusCode403() {
        ResponseEntity<String> response = restTemplate.exchange("/api/travels/1",GET,wrongHeader, String.class);
        Assertions.assertThat(response.getStatusCodeValue()).isEqualTo(403);
    }
     */
    ...
    public void listStudentsWhenTokenIsCorrectShouldReturnStatusCode200() {
        ResponseEntity<String> response = restTemplate.exchange("/api/travels/1",GET,protectedHeader, String.class);
    ...
    public void deleteWhenUserHasRoleAdminAndStudentExistsShouldReturnStatusCode200() {
        BDDMockito.doNothing().when(travelRepository).delete(1L);
    ...
    public void createWhenNameIsNullShouldReturnStatusCode400BadRequest() throws Exception {
        ...
        BDDMockito.when(travelRepository.save(student)).thenReturn(student);
